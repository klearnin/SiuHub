              ...
              <div class="basic-info">
                ...
                <div v-if="selectedPerson.type === 'player'" class="detail-section">
                  ...
                  <div class="detail-row">
                    ...
                    <el-select
                      v-model="selectedPerson.dominant_foot"
                      placeholder="请选择惯用脚"
                      clearable
                      class="el-select-position"
                      style="width: 72%;"
                    >
                      <el-option label="左脚" value="左脚" />
                      <el-option label="右脚" value="右脚" />
                    </el-select>
                  </div>
                  <div class="detail-row">
            ...
            <div v-if="selectedPerson.type === 'player'" class="right-section">
              <div class="position-rating-section">
                <div class="detail-row">
                  ...
                  <el-select
                    v-model="selectedPerson.position"
                    placeholder="请选择位置"
                    clearable
                    class="el-select-position"
                    style="width:100%"
                  >
                    ...
                    <el-option label="影锋" value="影锋" />
                    <el-option label="左边锋" value="左边锋" />
                    <el-option label="右边锋" value="右边锋" />
                    <el-option label="前腰" value="前腰" />
                    <el-option label="左前卫" value="左前卫" />
                    <el-option label="右前卫" value="右前卫" />
                    <el-option label="中前卫" value="中前卫" />
                    <el-option label="后腰" value="后腰" />
                    <el-option label="左后卫" value="左后卫" />
                    <el-option label="右后卫" value="右后卫" />
                    <el-option label="中后卫" value="中后卫" />
