...
// 帖子相关
router.post("/post", auth, forumController.createPost); // 创建帖子
router.get("/posts", forumController.getPosts); // 获取帖子列表及前三高赞评论
...
router.get("/comments", forumController.getCommentsWithReplies); // 获取评论及其回复（含头像、点赞数）
